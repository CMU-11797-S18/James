...
class CharEmbed(nn.Module):
    def __init__(self, vocab_size, k_height=0, embed_dim=50, output_dim=200):
        ...
        self.conv = nn.Conv2d(1, output_dim, (k_height, embed_dim))
    ...
    def forward(self, char_sequences):
        ...
        # batch_size*c_out
        word_char_embed = F.max_pool1d(conv_result, conv_result.size(2))

...
class SingletonMetaMap:
	def __init__(self):
		self.mm = MetaMap.get_instance('/home/star/Downloads/public_mm/bin/metamap')
		self.start_command = "/home/star/Downloads/public_mm/bin/skrmedpostctl start"
		self.stop_command = "/home/star/Downloads/public_mm/bin/skrmedpostctl stop"
